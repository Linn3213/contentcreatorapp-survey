...
const ContentSurvey = () => {
  ...
  const decorLineLeft = {
    height: '1px',
    width: '64px',
    background: 'linear-gradient(to right, transparent, rgba(139, 115, 94, 0.4))'
  };

  const decorLineRight = {
    height: '1px',
    width: '64px',
    background: 'linear-gradient(to left, transparent, rgba(139, 115, 94, 0.4))'
  };
      ...
      <div style={pageStyle}>
        <div style={containerStyle}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '40px' }}>
            ...
            <div style={labelStyle}>Marknadsundersökning</div>
